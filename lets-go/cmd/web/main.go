...
func main() {
	...
	// Use the scs.New() function to inititalize a new session manager. Then we
	// configure it to use our MySQL database as the session store, and set a
	// lifetime of 12 hours (expires after 12 hours)
	...
	srv := &http.Server{
		...
		// you would prefere to log the server errors at a Warn level instead, you
		// could pass slog.LevelWarn as the final paramater.
